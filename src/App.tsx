...
// Hero ORIGINAL da home (mão com grãos de cereja + logo + slogan). Restaurado a pedido do Vlademir:
// a ABERTURA (HeroGate) vem antes, e ao clicar "CONHEÇA A SAPORINO" a home abre do jeito que sempre foi.
