// Página MÁQUINAS E MOINHOS DE CAFÉ da COFICO (#maquinas).
//
...
import { ArrowRight, Coffee, Cog, Wrench, Store } from 'lucide-react';
...
const WA_MAQUINAS = whatsAppCofico(COFICO.phone, 'Olá! Vim pelo site da COFICO e quero falar sobre máquinas e moinhos de café.');
...
const BLOCOS = [
  ...
  { icon: Cog, t: 'Moinhos de café', d: 'Para quem mói na hora, no balcão ou na cozinha: o grão fresco na xícara, com a regulagem do ponto de moagem.' },
  { icon: Store, t: 'Com o café junto', d: 'Máquina, moinho e abastecimento de café no mesmo fornecedor, com entrega na mesma rota.' },
...
export default function CoficoMaquinasPage() {
  useEffect(() => { document.title = 'Máquinas e moinhos de café — COFICO Brasil'; window.scrollTo(0, 0); }, []);
    ...
    <div id="topo" className="min-h-screen bg-white text-neutral-900 antialiased selection:bg-cofico-ink selection:text-white">
      ...
      <section className="mx-auto max-w-6xl px-6 pt-10 pb-16">
        <nav className="text-sm text-neutral-500" aria-label="Você está em">
          ...
          <span className="text-neutral-800 font-medium">Máquinas e moinhos de café</span>
        </nav>

        <h1 className="mt-4 text-3xl md:text-4xl font-black tracking-tight">Máquinas e moinhos de café</h1>
        <p className="mt-3 text-neutral-600 max-w-2xl">
          Do grão à xícara: além de abastecer, a COFICO fornece o equipamento que mói e serve o café no seu balcão.
        </p>
      ...
      <section className="border-t border-neutral-200">
        <div className="mx-auto max-w-6xl px-6 py-16">
          ...
          <p className="mt-6 text-sm text-neutral-500">
            Modelos de máquina e de moinho, condições e prazo: fale com o comercial — montamos a proposta pelo seu consumo de café.
          </p>
        </div>
      </section>
