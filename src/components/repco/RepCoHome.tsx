...
interface Props { representativeId: string; onNavigateToRoute?: () => void; onNavigateToClient?: (clientId: string) => void; }
...
export default function RepCoHome({ representativeId, onNavigateToRoute, onNavigateToClient }: Props) {
